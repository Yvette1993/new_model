...
def main():
    ...
    # optionally resume from a checkpoint
        ...
        output_directory = os.path.dirname(chkpt_path)
    ...
    # create new model
        ...
        if args.arch == 'NewModel':
            model = models.NewModel(decoder=args.decoder, output_size=train_loader.dataset.output_size,
                in_channels=in_channels, pretrained=args.pretrained)
        elif args.arch == 'NewModelSkipAdd':
            model = models.NewModelSkipAdd(output_size=train_loader.dataset.output_size, pretrained=args.pretrained)
            #print(model)
        elif args.arch == 'NewModelSkipConcat':
            model = models.NewModelSkipAdd(output_size=train_loader.dataset.output_size, pretrained=args.pretrained)
